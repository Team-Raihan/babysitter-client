          ...
          <div className="p-5 bg-white md:flex-1">
            ...
            <form onSubmit={handleRegister} className="flex flex-col space-y-5">
              ...
              <div>
                <button
                  type="submit"
                  className="w-full px-4 py-2 text-lg font-semibold text-gray-700 transition-colors duration-300 bg-gray-500 rounded-md shadow hover:bg-gray-600 focus:outline-none "
                >
                  Register Now
                </button>
              </div>
