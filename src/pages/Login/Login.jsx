  ...
  return (
    <>
      <div className="flex items-center min-h-screen p-4 bg-gray-100 lg:justify-center">
        <div className="flex flex-col overflow-hidden bg-green rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-md">
          <div className="p-4 py-6 text-white bg-dark-500 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly">
          ...
          <div className="p-5 bg-white md:flex-1">
            ...
            >
              ...
              <div>
                <button
                  type="submit"
                  className="w-full px-4 py-2 text-lg font-semibold text-gray-700 transition-colors duration-300 bg-gray-500 rounded-md shadow hover:bg-blue-600 focus:outline-none "
                >
                  Log in
                </button>
              </div>
